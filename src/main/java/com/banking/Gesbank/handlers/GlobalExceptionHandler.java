package com.banking.Gesbank.handlers;

import com.banking.Gesbank.exceptions.ObjectValidationException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionRepresentation> handleBadCredentialsException(){
        ExceptionRepresentation representation = ExceptionRepresentation.builder()
                .errorMessage("You email and / or password is incorrect")
                .build();
        return ResponseEntity
                .status(HttpStatus.FORBIDDEN)
                .body(representation);
